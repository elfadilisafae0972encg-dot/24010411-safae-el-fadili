...
**Conversion des Types de Données** :La colonne 'Period Ending' a été convertie en type datetime. Cette conversion est essentielle pour permettre l'extraction de caractéristiques temporelles (année, mois, jour, trimestre) et faciliter l'analyse des tendances sur le temps.
